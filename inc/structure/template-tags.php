	...
	function aemi_posted_info()
	{
		if ( is_page() )
		{
			?><div class="post-details">
				<div class="post-mod"><span class="meta-detail"><?php echo esc_html__( 'Updated: ', 'aemi' ); ?></span><?php the_modified_time( 'F j, Y - g:i a'); ?></div>
			</div><?php
		}
		else
		{
			?><div class="post-details">
				...
				?><div class="post-mod"><span class="meta-detail"><?php echo esc_html__( 'Updated: ', 'aemi' ); ?></span><?php the_modified_time(); the_modified_time(' - g:i a'); ?></div>
			</div><?php
		}
	}
}
	...
	{ 
		?><div class="post-meta"><?php
			...
			if ( 'post' === get_post_type() && is_singular() )
			{
				...
				{
					?><div class="post-cats"><span class="meta-detail"><?php echo esc_html__( 'Categories: ', 'aemi' ); ?></span><?php the_category( ' + ' ); ?></div><?php
				}
			}
